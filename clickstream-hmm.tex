...
\begin{abstract}
  ...
  platform itself in a completely unsupervised manner by applying an
  unsupervised two-layer hidden Markov model (2L-HMM). We find that
  patterns extracted by such a 2L-HMM are interpretable, meaningful, and
  unique, and we demonstrate that features extracted from a trained 2L-HMM
  can be shown to correlate with educational outcomes.
\end{abstract}
